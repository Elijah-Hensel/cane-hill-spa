...
const useSlider = (slideImage, slideComponent, images) => {
  let slideCounter = 0
  ...
  const startSlider = () => {
    ...
    slideComponent.current.innerHTML = images[0].text
  }
  ...
  const handleSlide = (slide) => {
    ...
    slideComponent.current.innerHTML = images[slide - 1].text
  ...
  const goToNextSlide = () => {
    ...
    slideComponent.current.innerHTML = images[slideCounter + 1].text
    slideCounter++
    animateSlide(slideImage)
  }
